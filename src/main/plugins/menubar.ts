        ...
        submenu: [
          {
            ...
            click: () => utils.getWindow().webContents.executeJavaScript(`app.appRoute('about').catch(e => console.error("[executeJavaScript] Error:", e))`),
          },
          { type: "separator" },
          {
            ...
            click: () => utils.getWindow().webContents.executeJavaScript(`app.cfg.general.privateEnabled = !app.cfg.general.privateEnabled`).catch(e => console.error("[executeJavaScript] Error:", e)),
          },
          {
            ...
            click: () => utils.getWindow().webContents.executeJavaScript(`app.openSettingsPage().catch(e => console.error("[executeJavaScript] Error:", e))`),
          },
      ...
      },
      {
        ...
        submenu: [
          ...(this.isMac ? [{ role: "reload" }, { role: "forceReload" }, { role: "toggleDevTools" }, { type: "separator" }, { role: "resetZoom" }, { role: "zoomIn" }, { role: "zoomOut" }, { type: "separator" }, { role: "togglefullscreen" }, { type: "separator" }] : []),
          {
            ...
            click: () => utils.getWindow().webContents.executeJavaScript("app.focusSearch().catch(e => console.error("[executeJavaScript] Error:", e))"),
          },
          { type: "separator" },
          {
            ...
            click: () => utils.getWindow().webContents.executeJavaScript(`app.appRoute('listen_now').catch(e => console.error("[executeJavaScript] Error:", e))`),
          },
          {
            ...
            click: () => utils.getWindow().webContents.executeJavaScript(`app.appRoute('browse').catch(e => console.error("[executeJavaScript] Error:", e))`),
          },
          { type: "separator" },
          {
            ...
            click: () => utils.getWindow().webContents.executeJavaScript(`app.appRoute('library-recentlyadded').catch(e => console.error("[executeJavaScript] Error:", e))`),
          },
          {
            ...
            click: () => utils.getWindow().webContents.executeJavaScript(`app.appRoute('library-songs').catch(e => console.error("[executeJavaScript] Error:", e))`),
          },
          {
            ...
            click: () => utils.getWindow().webContents.executeJavaScript(`app.appRoute('library-albums').catch(e => console.error("[executeJavaScript] Error:", e))`),
          },
          {
            ...
            click: () => utils.getWindow().webContents.executeJavaScript(`app.appRoute('library-artists').catch(e => console.error("[executeJavaScript] Error:", e))`),
          },
        ],
      },
      {
        ...
        submenu: [
          {
            ...
            accelerator: "Space",
            click: () => utils.getWindow().webContents.executeJavaScript(`app.SpacePause().catch(e => console.error("[executeJavaScript] Error:", e))`),
          },
          {
            label: utils.getLocale(utils.getStoreValue("general.language"), "term.next"),
            accelerator: "CommandOrControl+Right",
            click: () => utils.getWindow().webContents.executeJavaScript(`MusicKitInterop.next().catch(e => console.error("[executeJavaScript] Error:", e))`),
          },
          {
            label: utils.getLocale(utils.getStoreValue("general.language"), "term.previous"),
            accelerator: "CommandOrControl+Left",
            click: () => utils.getWindow().webContents.executeJavaScript(`MusicKitInterop.previous().catch(e => console.error("[executeJavaScript] Error:", e))`),
          },
          { type: "separator" },
          {
            label: utils.getLocale(utils.getStoreValue("general.language"), "menubar.options.volumeup"),
            accelerator: "CommandOrControl+Up",
            click: () => utils.getWindow().webContents.executeJavaScript(`app.volumeUp().catch(e => console.error("[executeJavaScript] Error:", e))`),
          },
          {
            label: utils.getLocale(utils.getStoreValue("general.language"), "menubar.options.volumedown"),
            accelerator: "CommandOrControl+Down",
            click: () => utils.getWindow().webContents.executeJavaScript(`app.volumeDown().catch(e => console.error("[executeJavaScript] Error:", e))`),
          },
          { type: "separator" },
          {
            ...
            click: () => utils.getWindow().webContents.executeJavaScript(`app.modals.castMenu = true`).catch(e => console.error("[executeJavaScript] Error:", e)),
          },
          {
            ...
            click: () => utils.getWindow().webContents.executeJavaScript(`app.appRoute('remote-pair').catch(e => console.error("[executeJavaScript] Error:", e))`),
          },
          { type: "separator" },
          {
            ...
            click: () => utils.getWindow().webContents.executeJavaScript(`app.modals.audioSettings = true`).catch(e => console.error("[executeJavaScript] Error:", e)),
          },
          { type: "separator" },
          {
            ...
            click: () => utils.getWindow().webContents.executeJavaScript(`app.modals.pluginMenu = true`).catch(e => console.error("[executeJavaScript] Error:", e)),
          },
        ],
      },
      {
        ...
        submenu: [
          {
            ...
            click: () => utils.getWindow().webContents.executeJavaScript(`app.appRoute('apple-account-settings').catch(e => console.error("[executeJavaScript] Error:", e))`),
          },
          {
            label: utils.getLocale(utils.getStoreValue("general.language"), "menubar.options.signout"),
            click: () => utils.getWindow().webContents.executeJavaScript(`app.unauthorize().catch(e => console.error("[executeJavaScript] Error:", e))`),
          },
        ],
      },
      {
